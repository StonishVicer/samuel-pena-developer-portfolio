...
const translations = {
  en: {
    ...
    "skills-tools-2": "Docker",
    "skills-tools-3": "CI/CD (GitHub Actions)",
    "skills-tools-4": "Vercel / Netlify / AWS / DigitalOcean",
    ...
    "trainup-creds-admin-label": "Admin",
    "trainup-creds-client-label": "Demo Client",
    "trainup-creds-email": "Email:",
    "trainup-creds-password": "Password:",
    "trainup-link-landing": "Visit TrainUP",
    "trainup-link-demo": "Demo",
    "trainup-feat-short-1": "Memberships",
    "trainup-feat-short-2": "Bookings",
    "trainup-feat-short-3": "Payments",
    "trainup-feat-short-4": "Body Metrics",
    "trainup-feat-short-5": "Admin Panel",
    "trainup-feat-short-6": "Client Portal",
    "trainup-feat-short-7": "Notifications",
    "trainup-feat-short-8": "Security",
    "trainup-benefits-short": "Mobile-first · Multi-platform · Integrated payments",
    "trainup-mobile-note": "TrainUP is a mobile-first application. It looks best on mobile devices or using responsive developer tools in desktop browsers. The app is in active development.",
  ...
  es: {
    ...
    "trainup-creds-admin-label": "Administrador",
    "trainup-creds-client-label": "Cliente Demo",
    "trainup-creds-email": "Email:",
    "trainup-creds-password": "Contraseña:",
    "trainup-link-landing": "Visita TrainUP",
    "trainup-link-demo": "Demo",
    "trainup-feat-short-1": "Membresías",
    "trainup-feat-short-2": "Reservas",
    "trainup-feat-short-3": "Pagos",
    "trainup-feat-short-4": "Métricas",
    "trainup-feat-short-5": "Panel Admin",
    "trainup-feat-short-6": "Portal Cliente",
    "trainup-feat-short-7": "Notificaciones",
    "trainup-feat-short-8": "Seguridad",
    "trainup-benefits-short": "Mobile-first · Multiplataforma · Pagos integrados",
    "trainup-mobile-note": "TrainUP es una aplicación mobile-first. Se visualiza mejor en dispositivos móviles o usando la vista de desarrollo responsiva en navegadores. La app está en desarrollo activo.",
